<h1 align="center">SpaceX - HTML</h1>
...
- Adiquirir proficiência em HTML.
- Praticar a construção de um site usando anchor para outras páginas.
- Praticar a construção de um menu de navegação com css.
